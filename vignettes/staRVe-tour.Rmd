...
- **init_range**: nominally the spatial range parameter of the covariance function. In practice the value is irrelevant as long as it is "large enough".
...
For a more detailed explanation of the directed acyclic graph and the spatial range parameter, see section ###.
