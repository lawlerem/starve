...
- **space(...covariance=,nu=)**: Spatially structured covariates should be supplied in the first argument, if desired. The covariate terms supplied here need to be a subset of the terms supplied to the "covariates" part of the model formula. The name of the covariance function should be given to the covariance argument. If using the 'matern' covariance function, supplying a value to the nu option fixes the smoothness parameter nu at that value. Can be omitted from the formula, in which case the default exponential covariance function will be used.
